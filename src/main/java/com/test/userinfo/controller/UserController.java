...
public class UserController {
    ...
    public ModelAndView register(@RequestParam("loginname") String loginname,
                                 ...
                                 ModelAndView mv){
        int i = userService.register(loginname,password,username,phone,address);
        if (i == 1){
    ...
    public void updateUserInfo(@RequestParam("username") String username,
                               @RequestParam("id")int id){
        userService.updateUserInfo(username,id);
    }
